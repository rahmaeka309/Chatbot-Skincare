...
<div class="container-fluid">
	<div class="row">
		<div class="col-lg-12 <?php echo isMobileDevice() == false ? : '' ?>" style="font-size: 12pt;">
			<div class="card direct-chat direct-chat-primary" id="chat_convo">
              <div class="card-header ui-sortable-handle" style="cursor: move;">
                <h1 style="font-size: 15pt;" class="card-title">Tanya Yuk!</h1>
              ...
              <div class="card-footer">
                <form id="send_chat" method="post">
                  <div class="input-group">
                    <textarea style="font-size: 12pt;" type="text" name="message" placeholder="Type Message ..." class="form-control" required=""></textarea>
                    <span class="input-group-append">
                      <button type="submit" class="btn btn-primary" style="font-size: 12pt;">Kirim</button>
                    </span>
                  </div>
                </form>
              </div>
